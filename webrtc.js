...
(function (global) {
  ...
  /* ── ICE servers — Metered TURN (static credentials, global relay) */
  const ICE_SERVERS = [
    { urls: 'stun:stun.relay.metered.ca:80' },
    {
      urls:       'turn:global.relay.metered.ca:80',
      username:   'd6f9db65016d31869a36d2eb',
      credential: 'moCFAAFn06/BvDYh',
    },
    {
  ...
  function _getIceServers() { return Promise.resolve(ICE_SERVERS); }
