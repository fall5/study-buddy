...
(function (global) {
  ...
  const PRESETS = [
    '#071d2e','#ef4444','#f97316','#eab308',
    '#22c55e','#3b82f6','#143352','#ec4899',
    '#64748b','#000000',
  ];
      ...
      <div class="sbwb-toolbar">
        ...
        <div class="sbwb-group sbwb-colors">
          <label class="sbwb-color-swatch" title="Custom colour">
            <input  type="color" class="sbwb-color-input" value="#071d2e">
            <span   class="sbwb-color-dot" style="background:#071d2e"></span>
          </label>
        ...
        <div class="sbwb-group sbwb-actions">
          ...
          <button class="sbwb-btn sbwb-save-btn" data-action="save" title="Save to notepad">${ICON.save} <span class="sbwb-save-label">Save</span></button>
